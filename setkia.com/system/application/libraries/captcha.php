...
|
*/
function create_captcha($data = '', $img_path = '', $img_url = '', $font_path =  '', $font_path1 = '', $font_path2 = '', $font_path3 = '', $font_path4 = '')
{
    $defaults = array('word' => '', 'img_path' => '', 'img_url' => '', 'img_width' => '100', 'img_height' => '30', 'font_path' => '', 'font_path1' => '' ,'font_path2' => '', 'font_path3' => '', 'font_path4' => '', 'expiration' => 7200);
    ...
    */
    ...
    $multiple_fonts = ($font_path1 != '') ? TRUE : FALSE;
    $num_fonts = 0;
    $fontArr = array('0' => $font_path);

    if($font_path1 != '')
    {
        $num_fonts = 1;
         $fontArr['1'] = $font_path1;
        if($font_path2 != '')
        {
            $num_fonts = 2;
             $fontArr['2'] = $font_path2;
            if($font_path3 != '')
            {
                $num_fonts = 3;
                 $fontArr['3'] = $font_path3;
                if($font_path4 != '')
                {
                    $num_fonts = 4;
                     $fontArr['4'] = $font_path4;
                }
            }
        }
    }
    ...
    for ($i = 0; $i < strlen($word); $i++)
    {
        ...
        {
            $random = rand(0, $num_fonts);
           
            $fonttouse = $fontArr[$random];
            
            $y = rand($img_height/2, $img_height-3);
            imagettftext($im, $font_size, $angle, $x, $y, $text_color, $fonttouse, substr($word, $i, 1));
            $x += $font_size;
        }
    }
